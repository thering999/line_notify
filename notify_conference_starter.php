        ...
        array_push($flex_message["contents"]["contents"],[
          ...
          "body"=> [
            ...
            "contents"=> [
              ...
              [
                "type"=>"text",
                "text"=>" ** หากต้องการให้อำเภอเข้าร่วมด้วย กรุณาแจ้งงานไอที เบอร์ภายใน 114 **",
                "align"=> "center",
                "wrap" => true
              ],
              [
            ...
            "contents"=> [
              [
                ...
                "action"=> [
                  "type"=> "uri",
                  "label"=> "จองห้องประชุม",
                  "uri"=> "https://www.npm.moph.go.th/room_booking/"
                ],
                "color"=> "#217039",
                "height"=> "sm",
                "style"=> "primary"
...
$SITE = 70;
$DEPPART = "เขตสุขภาพที่8|เขตสุขภาพที่ 8|อุดรธานี|สกลนคร|บึงกาฬ|หนองคาย|หนองบัว|นครพนม";
$PROVINCE = "นครพนม";
