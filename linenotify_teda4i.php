...
$sql="SELECT CONCAT('จำนวนเด็กปฐมวัยที่ได้รับการคัดกรองแล้วพบว่ามีพัฒนาการล่าช้าและส่งต่อเข้าสู่ TEDA4I ในระบบ HDC มีจำนวนทั้งหมด =','',COUNT(CID),'(คน) ข้อมูล ณ วันที่ ' ,now(),' ท่านสามารถเช็คข้อมูลได้ที่',' ','http://203.157.102.149',' ','หรือติดต่อ IT สสจ.ครับ') as total FROM t_tida4i where t_tida4i.f_date is NULL and t_tida4i.l_date is null;";
