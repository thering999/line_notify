...
$sql="SELECT CONCAT('จำนวนประชากรในเขตรับผิดชอบ Typearea 1,3 ไม่สามารถเชื่อมโยงบ้านที่อยู่ในเขต(แฟ้ม HOME)ในระบบ HDC =',' ',sum(result),' (คน) ข้อมูล ณ วันที่ ' ,now()) as total FROM e_pe0005 WHERE b_year = '2562';";
